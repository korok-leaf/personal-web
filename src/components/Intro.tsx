            ...
            <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
                ...
                <div className="relative flex justify-center items-center z-10">
                    <div className={`${animation === "first" ? "" : "group"} relative`}>
                        ...
                        {/* Popup */}
                        <div className="absolute w-[200] bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-gray-800 text-white text-sm px-4 py-2 rounded-lg shadow-lg text-center">
